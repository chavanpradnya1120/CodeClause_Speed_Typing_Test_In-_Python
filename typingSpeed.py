...
words = ['grapes', 'mango', 'run', 'fan', 'tv', 'mobile', 'laptop', 'apple',
         'banana', 'chair', 'dog', 'cat', 'table', 'sun', 'moon', 'star',
         'car', 'book', 'pencil', 'phone', 'computer', 'keyboard', 'mouse',
         'house', 'tree', 'flower', 'water', 'fire', 'earth', 'air', 'light',
         'door', 'window', 'mirror', 'clock', 'bed', 'shoe', 'hat', 'shirt',
         'pants', 'socks', 'guitar', 'piano', 'violin', 'drums', 'music',
         'dance', 'painting', 'artist', 'camera', 'photo', 'video', 'film',
         'restaurant', 'food', 'drink', 'coffee', 'tea', 'pizza', 'burger',
         'ice cream', 'chocolate', 'cake', 'cookie', 'character']
